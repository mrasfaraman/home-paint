...
export const Footer = () => {
  return (
    <div className="w-full pt-12 flex items-center justify-center bg-black">
      <div className="md:w-2/3 w-full px-4 text-white flex flex-col">
        <div className="w-full text-5xl xl:text-7xl font-bold">
        ...
        <div className="flex mt-8 flex-col md:flex-row md:justify-between">
          <p className="w-full md:w-2/3 text-gray-400">
            Elevate your space with our expert services: painting, door
            treatment, flooring, plumbing, electrical work, gypsum partitions,
            glass solutions, and AC duct maintenance.
          </p>
          <div className="w-44 pt-6 md:pt-0">
            <Link href="/contact-us" target="_blank" legacyBehavior>
              <a className="bg-red-500 hover:cursor-pointer hover:bg-red-700 transition-all justify-center text-center rounded-lg shadow px-10 py-3 flex items-center">
                Contact US
              </a>
            </Link>
          </div>
        ...
        <div className="flex flex-col">
          ...
          <p className="w-full text-center my-12 text-gray-600">
            Copyright © 2024 JJ-SoftSolutions
          </p>
        </div>
      </div>
    </div>
